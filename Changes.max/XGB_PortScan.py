...
XGB_PortScan.py
=========================================================
Robust XGBoost PortScan Classifier

Purpose
-------
Train and evaluate a production-oriented XGBoost
...
-----
Train:
    python XGB_PortScan.py train --data dataset.csv --out PortScan_XGB.pkl

Evaluate:
    python XGB_PortScan.py eval --model PortScan_XGB.pkl --data dataset.csv

Predict:
    python XGB_PortScan.py predict --model PortScan_XGB.pkl --data sample.csv
"""
...
def train(data_path, out_path):
    ...
    print("[6/8] Running inference...")
    probs = model.predict_proba(X_test)[:, 1]

    print("[7/8] Optimizing threshold...")
    threshold = optimize_threshold(y_test, probs)

    print("[8/8] Evaluating...")
    ...
    artifact = {
        ...
        "metadata": {
            "model_type": "XGBoost PortScan Detector",
...
def main():
    ...
    p1.add_argument("--out", default=r"C:\Users\Mayank Kumar Sagar\Desktop\MAX\Projects\FL-based-IDS-raw\Changes.max\models\PortScan_XGB.pkl")

    p2 = sub.add_parser("eval")
    p2.add_argument("--model", default=r"C:\Users\Mayank Kumar Sagar\Desktop\MAX\Projects\FL-based-IDS-raw\Changes.max\models\PortScan_XGB.pkl")
    ...
    p3.add_argument("--model", default=r"C:\Users\Mayank Kumar Sagar\Desktop\MAX\Projects\FL-based-IDS-raw\Changes.max\models\PortScan_XGB.pkl")
