...
Production-grade raw DDoS detection model using XGBoost.

Purpose
-------
This script trains and serves a standalone XGBoost model for
...
Train:
    python XGB_DDoS.py train --data ddos.csv --out ddos_xgb.pkl

Evaluate:
    python XGB_DDoS.py eval --model ddos_xgb.pkl --data test.csv

Predict:
    python XGB_DDoS.py predict --model ddos_xgb.pkl --data sample.csv
"""
...
class RawDDoSXGBoostModel:
    ...
    def train(self, csv_path):
        ...
        print("[3/8] Computing scale_pos_weight...")
        self.scale_pos_weight = compute_scale_pos_weight(
            y_train
        )

        print(f"scale_pos_weight = {self.scale_pos_weight:.4f}")

        print("[4/8] Building XGBoost model...")

        config = MODEL_CONFIG.copy()

        config["scale_pos_weight"] = self.scale_pos_weight
    ...
    def load(cls, path):
        ...
        obj.scale_pos_weight = artifact.get(
            "scale_pos_weight",
            1.0
        )
...
def main():
    ...
    p1.add_argument("--data", default=r"C:\Users\Mayank Kumar Sagar\Desktop\MAX\Projects\FL-based-IDS-raw\Changes.max\datasets\DDoS.csv")
    p1.add_argument("--out", default=r"C:\Users\Mayank Kumar Sagar\Desktop\MAX\Projects\FL-based-IDS-raw\Changes.max\models\DDoS_XGB.pkl")

    # EVAL
    p2 = sub.add_parser("eval")
    p2.add_argument("--model", default=r"C:\Users\Mayank Kumar Sagar\Desktop\MAX\Projects\FL-based-IDS-raw\Changes.max\models\DDoS_XGB.pkl")
    p2.add_argument("--data", default=r"C:\Users\Mayank Kumar Sagar\Desktop\MAX\Projects\FL-based-IDS-raw\Changes.max\datasets\DDoS.csv")

    # PREDICT
    p3 = sub.add_parser("predict")
    p3.add_argument("--model", default=r"C:\Users\Mayank Kumar Sagar\Desktop\MAX\Projects\FL-based-IDS-raw\Changes.max\models\DDoS_XGB.pkl")

    p3.add_argument("--data", default=r"C:\Users\Mayank Kumar Sagar\Desktop\MAX\Projects\FL-based-IDS-raw\Changes.max\datasets\DDoS.csv")
    ...
    # -----------------------------------------------------
        ...
        model = RawDDoSXGBoostModel.load(args.model)
