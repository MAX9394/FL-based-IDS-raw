# rf_dos_raw_model.py
# =========================================================
# Production-grade raw DoS detection model.
#
# PURPOSE
# -------
# Standalone Random Forest ML layer for DoS detection.
#
...
#
# Train:
#     python rf_dos_raw_model.py train --data dos.csv --out dos_rf.pkl
#
# Evaluate:
#     python rf_dos_raw_model.py eval --model dos_rf.pkl --data test.csv
#
# Predict:
#     python rf_dos_raw_model.py predict --model dos_rf.pkl --data sample.csv
# =========================================================
...
class RawDoSModel:
    ...
    def train(self, csv_path):
        ...
        print("[3/7] Skipping synthetic oversampling...")
...
def main():
    ...
    p1.add_argument("--out", default=r"C:\Users\Mayank Kumar Sagar\Desktop\MAX\Projects\FL-based-IDS-raw\Changes.max\models\DoS_RF.pkl")

    # EVAL
    p2 = sub.add_parser("eval")
    p2.add_argument("--model", default=r"C:\Users\Mayank Kumar Sagar\Desktop\MAX\Projects\FL-based-IDS-raw\Changes.max\models\DoS_RF.pkl")
    ...
    p3.add_argument("--model", default=r"C:\Users\Mayank Kumar Sagar\Desktop\MAX\Projects\FL-based-IDS-raw\Changes.max\models\DoS_RF.pkl")
    ...
    # -----------------------------------------------------
        ...
        model = RawDoSModel.load(args.model)
